# Contributing to search-ranking
...
classes only make sense wired into a real Spryker shop (Zed/Yves/Client layers, Propel-backed
persistence, Elasticsearch/OpenSearch documents). If you're working on a change that needs to be
exercised end-to-end, you'll need a Spryker demo shop with this package installed as a local path
repository — see the README's Installation section.
