...
class CalibrationSearcher implements CalibrationSearcherInterface
{
    ...
    /**
     * @var \SprykerCommunity\Client\SearchRanking\Search\RawRelevanceScoreExtractorInterface
     */
     ...
     * @param \SprykerCommunity\Client\SearchRanking\Search\RawRelevanceScoreExtractorInterface $rawRelevanceScoreExtractor
     */
    ...
    public function searchScores(string $searchTerm, string $storeName, string $localeName, int $limit): array
    {
        ...
        $indexName = $this->indexNameResolver->resolve(SearchRankingConfig::PAGE_SOURCE_IDENTIFIER, $storeName);
