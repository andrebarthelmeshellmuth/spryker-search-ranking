...
namespace SprykerCommunity\Zed\SearchRanking\Dependency\QueryContainer;

class SearchRankingToAclQueryContainerBridge implements SearchRankingToAclQueryContainerInterface
{
    /**
