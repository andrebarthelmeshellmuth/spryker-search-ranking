...
namespace SprykerCommunity\Zed\SearchRanking\Communication\Acl;

use Generated\Shared\Transfer\RuleTransfer;
use Generated\Shared\Transfer\SearchRankingBackOfficeAccessDiagnosisTransfer;
...
class BackOfficeAccessAnalyzer implements BackOfficeAccessAnalyzerInterface
{
    ...
    /**
     * @param \SprykerCommunity\Zed\SearchRanking\Dependency\Facade\SearchRankingToAclFacadeInterface $aclFacade
     */
    public function __construct(protected SearchRankingToAclFacadeInterface $aclFacade)
    {
    }
     ...
     */
    public function analyze(array $moduleNames): SearchRankingBackOfficeAccessDiagnosisTransfer
    {
        $diagnosisTransfer = new SearchRankingBackOfficeAccessDiagnosisTransfer();
     ...
     * controller/action (an adopter may well grant a role the metric pages but deny it
     * one destructive action) leaves the rest of the module reachable, and must not read as "no access".
     *
     * @param \Generated\Shared\Transfer\RuleTransfer $ruleTransfer
     */
