...
namespace SprykerCommunityTest\Zed\SearchRanking\Communication\Acl;
...
class BackOfficeAccessAnalyzerTest extends Unit
{
     ...
     * @var string
     */
    protected const MODULE_NAME = 'search-ranking-gui';
    ...
    /**
     * Granting a role the metric pages while denying it one destructive action is an ordinary split. That role
     * still very much reaches the module, and must not be counted as having no access.
     */
    ...
    protected function createAnalyzer(array $rulesByRoleId, ?array $roleIdsByGroupId = null): BackOfficeAccessAnalyzer
    {
        ...
        $aclFacadeMock = $this->createMock(SearchRankingToAclFacadeInterface::class);
