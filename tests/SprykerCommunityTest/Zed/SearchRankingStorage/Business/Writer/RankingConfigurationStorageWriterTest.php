...
class RankingConfigurationStorageWriterTest extends Unit
{
    ...
    protected function createConfigurationTransfer(
        ...
        return (new SearchRankingConfigurationStorageTransfer())
            ...
            // the hybrid-search `beta` field and was never updated for it; the strict transfer's own
            // getBetaOrFail() (see RankingConfigurationStorageWriter::KEY_BETA) needs a real value.
            ->setBeta(1.0)
